    ...
    useEffect(() => {
        if (data && !fetching) {
            setCreateDetails({
                ...
                customer_subject: data.customer_subject || "Confirmation: We've received your quote request [ORDER_NAME]",
                ...
                merchant_subject: data.merchant_subject || "Action Required: New Quote Request [ORDER_NAME]",
