...
// This file describes the schema for the "shopifyAppInstallation" model, go to https://quotes-draft-order-request.gadget.app/edit to view/edit your model in Gadget
