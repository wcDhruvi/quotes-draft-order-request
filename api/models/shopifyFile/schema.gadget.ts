...
// This file describes the schema for the "shopifyFile" model, go to https://quotes-draft-order-request.gadget.app/edit to view/edit your model in Gadget
...
export const schema: GadgetModel = {
  ...
  shopify: {
    fields: {
      ...
      mediaContentType: { filterIndex: false, searchIndex: false },
